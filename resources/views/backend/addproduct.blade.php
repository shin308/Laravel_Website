		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading" style="background: #b30000">Thêm sản phẩm</div>
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="layout/img/new_seo-10-512.png">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										<label>New</label>
										<input required type="text" name="new" class="form-control">
									</div>
									<div class="form-group" >
