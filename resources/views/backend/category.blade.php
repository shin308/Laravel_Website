		...
		<div class="row">
			<div class="col-xs-12 col-md-5 col-lg-5">
					<div class="panel panel-primary">
						<div class="panel-heading" style="background: #b30000">
							Thêm danh mục
						</div>
						<div class="panel-body">
							...
							<div class="form-group">
								<input style="background: #b30000" type="submit" name="submit" class="form-control btn btn-primary" placeholder="Tên danh mục..." value="Thêm danh mục mới">
							</div>
								{{csrf_field()}}
							</form>
							</div>
			...
			<div class="col-xs-12 col-md-7 col-lg-7">
				<div class="panel panel-primary">
					<div class="panel-heading" style="background: #b30000">Danh sách danh mục</div>
					<div class="panel-body">
